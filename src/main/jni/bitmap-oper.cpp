//
// Created by KCSTATION on 2017/4/4.
//
...
{
//store
//Java_com_ck_ind_finddir_toolkits_ImageTools_jniStoreBitmapData
JNIEXPORT jobject JNICALL Java_com_ck_ind_finddir_toolkits_ImageTools_jniStoreBitmapData(
        JNIEnv * env, jobject obj, jobject bitmap);
//get
JNIEXPORT jobject JNICALL Java_com_ck_ind_finddir_toolkits_ImageTools_jniGetBitmapFromStoredBitmapData(
        JNIEnv * env, jobject obj, jobject handle);
//================================free
//Java_com_jni_bitmap_1operations_JniBitmapHolder_jniFreeBitmapData
JNIEXPORT void JNICALL Java_com_ck_ind_finddir_toolkits_ImageTools_jniFreeBitmapData(
        JNIEnv * env, jobject obj, jobject handle);
//rotate 90 degrees CCW
JNIEXPORT void JNICALL Java_com_jni_bitmap_1operations_JniBitmapHolder_jniRotateBitmapCcw90(
        JNIEnv * env, jobject obj, jobject handle);
//rotate 90 degrees CW =========================================================changes
JNIEXPORT void JNICALL Java_com_ck_ind_finddir_toolkits_ImageTools_rotateBitmap(
        JNIEnv * env, jobject obj, jobject handle,jint angle);
//rotate 180 degrees
        ...
        JNIEnv * env, jobject obj, jobject handle,jint angle)
{
    ...
    if (jniBitmap->_storedBitmapPixels == NULL)
        return;
    uint32_t* previousData = jniBitmap->_storedBitmapPixels;
    uint32_t srcWidth = jniBitmap->_bitmapInfo.width;
    uint32_t srcHeight = jniBitmap->_bitmapInfo.height;
//    jniBitmap->_bitmapInfo.width = newWidth;
//    jniBitmap->_bitmapInfo.height = newHeight;
...
//
    ...
    LOGD("hehe:1x:%lf,2x:%lf,3x:%lf",Point1x,Point2x,Point3x);
    LOGD("hehe:1y:%lf,2y:%lf,3y:%lf",Point1y,Point2y,Point3y);
    LOGD("hehe:sine %lf ,cosine %lf,ccccccccc %lf",sine,cosine,cos(radians));
    LOGD("hehe:maxX:%lf,minX:%lf,maxY:%lf,minY:%lf",maxx,minx,maxy,miny);
    LOGD("caik un be here w:%d,h:%d,multi:%d,oldwh:%d,%d,angle %d,radians %lf",
         DestBitmapWidth,DestBitmapHeight,DestBitmapWidth*DestBitmapHeight,srcWidth,srcHeight,angle,radians);
//
    uint32_t* newBitmapPixels = new uint32_t[DestBitmapWidth * DestBitmapHeight];
