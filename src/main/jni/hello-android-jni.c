...
//                                                         jobject zBitmap) {
//    eprintf("Java_com_ck_ind_finddir_toolkits_ImageTools_rotateBitmap exec+\n");
//
//    // TODO
//    JNIEnv J = *env;
//
...
//JNIEXPORT void JNICALL
//Java_com_ck_ind_finddir_toolkits_ImageTools_rotateBitmap2(JNIEnv *env, jobject instance,
//                                                         jobject zBitmap,jint jInteger) {
//    eprintf(jInteger+"Java_com_ck_ind_finddir_toolkits_ImageTools_rotateBitmap exec+\n");
//
//    // TODO
//    JNIEnv J = *env;
//
...
//        return;
//    }
//    JniBitmap *jniBitmap = (JniBitmap *) J->GetDirectBufferAddress(zBitmap);
...
//    uint16_t *newBitmapPixels[newWidth * newHeight];
//    int whereToGet = 0;
//    // XY. ... ... ..X
//    // ...>Y..>...>..Y
//    // ... X.. .YX ...
